  ...
  return (
    <div className='w-full  pt-20 font-SFPro px-5 '>
        <div className='max-w-[1400px] mx-auto px-0 lg:px-10 md:py-5'>
            <div className=' flex flex-col lg:flex-row justify-between items-center gap-y-4 lg:h-[85vh] '>
                <div className=''>
                ...
                <motion.div className='w-90 flex justify-center items-center sm:h-[90%]'

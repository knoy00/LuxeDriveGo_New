...
function Hero() {
  return (
    <div className='w-full mt-0 px-5 font- md:px-10 lg:px-20 bg-black sm:bg-black md:bg-white lg:bg-white font-PPMori'>
      <div className='text py-10'>
        ...
        <motion.div className='flex justify-center items-center mt-10 bg-white w-55 h-10 md:mx-auto lg:mx-auto md:bg-black  rounded-2xl px-5 py-7 cursor-pointer border-2 border-black hover:bg-[#ddd] md:hover:bg-[#222]'
        initial={{opacity: 0, y: 250}}
        animate={{opacity:1, y: 0}}
        ...
        <motion.div className='flex flex-col justify-center items-center mt-20 space-y-10 text-black lg:flex-row lg:space-y-0 lg:gap-x-10 lg:max-w-[1400px] lg:mx-auto md:mt-40'
        initial={{opacity: 0, y: 130}}
        animate={{opacity:1, y: 0}}
        transition={{duration: 2, ease: 'easeOut'}}
        >
            <div className='bg-white w-full max-w-[500px] px-10 py-10 flex flex-col justify-center items-center rounded-4xl sm:w-150 sm:max-w-[590px] sm:mx-auto lg:h-[300px] md:bg-black md:text-[#fff]'>
                <CarTaxiFront color='white' size={60} className='mb-10 bg-black rounded-4xl p-2 md:border-3 md:border-white '/>
                <p className='h-[70px] text-[17px] font-regular'>Fast and convenient rides</p>
            </div>
            <div className='bg-white w-full max-w-[500px] px-10 py-15 flex flex-col justify-center items-center rounded-4xl sm:w-150 sm:max-w-[590px] sm:mx-auto md:bg-black md:text-[#fff]'>
